...
const TIMES = [
  ...
  "11:10", "12:00", "12:50", "13:40", "14:00", "14:50",
  "15:40", "16:30", "17:20", "18:10", "19:00",
  "19:50",
]

// Each slot maps to a time block (50-min class), except the recess at 13:40
function getTimeRange(time: string) {
  if (time === "13:40") return "13:40 - 14:00"
