...
export function AttendanceModule() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full overflow-y-auto md:overflow-hidden bg-background">
      {/* ── Left panel: calendar ── */}
      {!isFocusMode && (
        <aside className="flex w-full md:w-64 shrink-0 flex-col border-b md:border-b-0 md:border-r border-border bg-card/40">
          {/* Month nav */}
